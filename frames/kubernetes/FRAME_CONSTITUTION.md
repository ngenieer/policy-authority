# Frame Constitution — Kubernetes (v0.1)
Version: v0.1  
Status: Normative (Frame-Binding)  
Applies-To: Kubernetes Frame  
...
for the Kubernetes Frame admitted into the Policy Authority system.

It does **not** describe usage or behavior guarantees.
...
- Frame Name: Kubernetes Frame
- Frame Identifier: kubernetes-v0.1
...
- Explicitly excluded files/directories:
  ...
  - Helm charts/templates (`charts/**`, `templates/**`) unless rendered to static YAML
  - Generated artifacts outside the repo root
...
Snapshots are derivable from static files only and do **not** depend on:
- Runtime state
- Execution results
- Network access
...
- Execution of kubectl or any Kubernetes API calls
- Simulation of cluster behavior
- Validation against live clusters
...
- Business intent or operational correctness
- Security posture or compliance state
