# Frame Constitution — Kubernetes Security Sub-Frame (v0.1)
Version: v0.1
Status: Normative (Sub-Frame-Binding)
Applies-To: Kubernetes/Security Sub-Frame
Last-Updated: 2026-01-29

---

## 1. Scope
- Covers static Kubernetes manifest content relevant to security posture (e.g., RBAC objects, Pod security settings, secrets handling annotations).
- Excludes network concerns, performance, availability, cost, or any other sub-frame scopes.
